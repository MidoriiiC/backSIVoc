...
public class ArticleMapper {
	...
	public static Article entityToObject(ArticleEntity a) {
		return new Article(a.getId(), a.getTitle(), a.getContent(), a.getAuthor(), a.getDate(), a.getHour(), a.getIllustration());
	}
	
	public static ArticleDTO objectToDTO(Article a) {
		return new ArticleDTO(a.getId(), a.getTitle(), a.getContent(), a.getAuthor(), a.getDate(), a.getHour(), a.getIllustration());
	}
	...
	public static ArticleEntity objectToEntity(Article a) {
		return new ArticleEntity(a.getId(), a.getTitle(), a.getContent(), a.getAuthor(), a.getDate(), a.getHour(), a.getIllustration());
	}
	...
	public static List<Article> listEntityToListObject(List<ArticleEntity> articles) {
		...
		for(ArticleEntity a : articles) {
			articlesObject.add(new Article(a.getId(), a.getTitle(), a.getContent(), a.getAuthor(), a.getDate(), a.getHour(),a.getIllustration()));
		}
	...
	public static List<ArticleDTO> listObjectToListDTO(List<Article> articles) {
		...
		for(Article a : articles) {
			articlesDTO.add(new ArticleDTO(a.getId(), a.getTitle(), a.getContent(), a.getAuthor(), a.getDate(), a.getHour(), a.getIllustration()));
		}
		return articlesDTO;
	}
